...
* Optional dependencies (optdepends) and check dependencies (checkdepends) are not installed. They are skipped. Check them out manually when you review PKGBUILD.
